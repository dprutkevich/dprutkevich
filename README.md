# Hi there, I'm Dmytro Prutkevych! 👋
...
I'm a highly experienced .NET developer and tech lead with a strong background in cloud infrastructure, backend architecture, and fullstack development. Over a decade in the industry, I've worked on enterprise systems, payment platforms, and scalable APIs.

- 🔭 Currently working at **EPAM Systems** as Tech Lead
- ☁️ AWS Certified Solutions Architect – Associate
- 🧱 Infrastructure-as-Code advocate using **Terraform**
- 👨‍🏫 Passionate about clean architecture, testing, and automation. DevOps
- 🧩 Experienced in complex integrations with 3rd-party systems (Zendesk, Credit Bureau, etc.)

---

### 💼 Work Experience

**EPAM Systems** (2023–Present) — *Tech Lead*  

**Innovecs** (2020–2023) — *Advanced .NET Developer / Cloud Infrastructure Engineer*  

**Ciklum** (2019–2020) — *Fullstack .NET Developer*  
